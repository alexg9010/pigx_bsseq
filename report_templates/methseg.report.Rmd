...
The segmentation based on methylation provides a way to compress the information from base-pair into regional resolution, allowing the smoothing of the genome wide signal and enabling the detection of regions with similar methylation values, that might be interesting for further investigations.
